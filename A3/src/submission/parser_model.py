...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden.weight = nn.init.xavier_uniform(self.embed_to_hidden.weight)
        self.activation = nn.ReLU()
        self.dropout_layer = nn.Dropout(p=dropout_prob)
        self.hidden_to_logits = nn.Linear(self.hidden_size, self.n_classes)
        self.hidden_to_logits.weight = nn.init.xavier_uniform(self.hidden_to_logits.weight)
        ### END CODE HERE
    ...
    def embedding_lookup(self, t):
        ...
        # t has shape batch_size, n_features
    ...
    def forward(self, t):
        ...
        embeds     = self.embedding_lookup(t)
        linear1    = self.embed_to_hidden(embeds)
        h          = self.activation(linear1)
        dropout    = self.dropout_layer(h)
